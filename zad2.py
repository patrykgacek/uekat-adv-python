class Library:
    ...
    def __str__(self) -> str:
        return f'{self.city} {self.street} {self.zip_code} {self.open_hous} {self.phone}'
...
employee_1 = Employee('Jan', 'Nowak', '2021-01-01', '1990-01-01', 'Warszawa', 'Marszalkowska', '00-001', '468-234-122')
employee_2 = Employee('Beata', 'Opalony', '2021-06-10 ', '1990-05-30', 'Krakow', 'Krakowska', '00-002', '112-775-345')
employee_3 = Employee('Krzysztof', 'Kowalski', '2021-01-01', '1990-01-01', 'Warszawa', 'Marszalkowska', '00-001', '234-222-888')
