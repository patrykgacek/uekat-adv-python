...
parser.add_argument(
    '--city', 
    type=str, 
    help='Filter breweries by city. You can use underscores or url encoding for spaces.')
args = parser.parse_args()

by_city_arg = args.city
by_city_query = f'&by_city={by_city_arg}' if by_city_arg else ''
url = f'https://api.openbrewerydb.org/breweries?per_page=20{by_city_query}'
